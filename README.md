...
1. Run this command:
	...
	```bash
	cd /tmp; wget --no-check-certificate -O ISPConfig3.tgz https://github.com/jordimorillo/ISPConfig-3-Debian-Installer/tarball/master; tar zxvf ISPConfig3.tgz; cd *Installer*; bash install.sh
	```
